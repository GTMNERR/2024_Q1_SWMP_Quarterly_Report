...
#| echo: false
#| fig-cap: "Hourly wind speed and direction from the Pellicer Creek weather station during the timeperiod of the longest Noreaster observed at the station (Saturday, March 23 - Tuesday, March 26, 2024). The circles represent wind direction in degrees. All data is based upon 5 second maximum wind speed readings at the weather station."
#| fig.subcap:
...
MET %>% 
  filter(between(datetimestamp, 
                 as.POSIXct("2024-03-23 00:00:00"), 
                 as.POSIXct("2024-03-26 23:45:00"))) %>% 
...
#| echo: false
#| fig.cap: Daily wind speed and direction from the Pellicer Creek weather station during the timeperiod of the longest Noreaster observed at the station (Saturday, March 23 - Tuesday, March 26, 2024). All data is based upon 5 second averge wind speed readings."
#| fig.subcap:
#|    - "Daily wind speeds"
#| layout-ncol: 1
...
MET_wind_long <- MET %>%
  filter(between(datetimestamp,
                 as.POSIXct("2024-03-24 00:00:00"),
                 as.POSIXct("2024-03-26 23:45:00")))
...
#| echo: false
#| fig.cap: Hourly wind speed and direction from the Pellicer Creek weather station during the timeperiod of the longest Noreaster observed at the station (Saturday, March 23 - Tuesday, March 26, 2024). The warmer the color, the higher the recorded wind speed. The arrows indicate the direction the wind was blowing towards and the length of the arrow reflects the wind speed information with longer meaning faster. All data is based upon 5 second readings at the weather station.
#| fig.subcap:
...
MET_wind_q1 <- MET %>% 
  filter(between(datetimestamp, 
                 ...
                 as.POSIXct("2024-03-31 23:45:00")))

plot_wind(MET_wind_q1, type = 'month', main = NULL, annotate = TRUE)
