...
pi <- subset(pi_1, subset = '2024-04-01 0:00', operator = '<')    
...
ss <- subset(ss_1, subset = '2024-04-01 0:00', operator = '<')
...
fm <- subset(fm_1, subset = '2024-04-01 0:00', operator = '<')
...
pc <- subset(pc_1, subset = '2024-04-01 0:00', operator = '<')
...
MET <- subset(MET_1, subset = '2024-04-01 0:00', operator = '<')
