...
pi_nut <- subset(pi_nut_1, subset = '2024-04-01 0:00', operator = '<')
ss_nut <- subset(ss_nut_1, subset = '2024-04-01 0:00', operator = '<')
fm_nut <- subset(fm_nut_1, subset = '2024-04-01 0:00', operator = '<')
pc_nut <- subset(pc_nut_1, subset = '2024-04-01 0:00', operator = '<')
